/*
  ...
  Purpose:       Compute the bitangents of a collection of curves (or a 2d scene).
  ...
  Input: 	 k 2d point sets, implicitly defining k interpolating cubic 
  		 Bezier curves
  Status:        Cleaning. 
                 Exportable once Scene part of main function has been tested.
  Copyright 2003 by John K. Johnstone.
  History: 	 6/4/03: Added scene input capability.
                 7/6/03: Cleaned.
...
#include "curve/BezierCurve.h"	// inputCurves
#include "curve/Scene2d.h"
#include "tangcurve/TangCurve.h" // buildTangentialCurves, CommonTangent, intersect, draw, visible
...
int main (int argc, char **argv)
{
  ...
  else inputCurves(argv[argc-1], nPtsPerSegment, obstacle);
