...
of untrimmed bisectors as a variable--distance offsets in the simple
case of a parabola.
...
{pellipse}) has radii of curvature $r=k^2$ at the vertices $t=0$ and
$t=\pm\infty$, and $r=1/k$ at the vertices $t=-1$ and $t=+1$. Thus,
