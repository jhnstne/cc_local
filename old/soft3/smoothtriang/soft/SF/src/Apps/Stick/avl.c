...
static insertAvl(    AVL *node,    int (*func)(),     char *data);
static char *recFind(     AVL node,     int (*func)(),     char *data);
 ...
 *	char *data	- the element to be inserted
 *  Return Value:
 *	void
 *---------------------------------------------------------------------
 */
void insert(    AVL_TREE avl,     char *data)
  {
 ...
 *	char *data	- the new element to be inserted
 *  Return Value:
 *	none
 *---------------------------------------------------------------------
 */
 ...
 *	char 		*data	- the data to find.
 *  Return Value:
 *	char *			- the data found (NULL if not in
 *				  tree).
 *---------------------------------------------------------------------
 */
char *find(     AVL_TREE tree,     char *data)
  {
 ...
 *	char	*data		- the data to find
 *  Return Value:
 *	char *		- the data found (NULL if not found).
 *---------------------------------------------------------------------
 */
static char *recFind(     AVL node,     int (*func)(),     char *data)
  {
