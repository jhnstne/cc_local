...
** point net.
*/
static Point AffineBlend(Point *net, int i1, int i2, int i3, 
...
*/
Patch PatchCreate(int degree, Space range, int normaldim)
{
    Patch new;
...
*/
void PatchSetPoint(Patch *patch, Point pt, int i1, int i2, int i3)
{
...
*/
void PatchSetNormal(Patch *patch, Normal normal, int i1, int i2, int i3)
{
...
** is (i1,i2,i3).
*/
VERTEX PatchGetVertex(Patch p, int i1, int i2, int i3)
{
...
*/
Point PatchGetPoint(Patch p, int i1, int i2, int i3)
{
    VERTEX v;
...
Point	PatchSafeGetPoint(Patch p, int i1, int i2, int i3)
   {
   Point	Zero;
...
*/
Normal PatchGetNormal( Patch p, int i1, int i2, int i3)
{
    VERTEX v;
...
void	PatchWrite(FILE *fp, Patch patch)
   {
   int	i, j, numvertices;
   char buf[100];
   Scalar x[3], nx[3];
...
** are (r, s, t)
*/
Point PatchEval(Patch  patch, Scalar r, Scalar s, Scalar t)
{
    Point surfacePoint;
    Normal normal;
...
** the point.
*/
void PatchEvalWithNormal(Patch patch, Point *point, Normal *normal,
			 Scalar r, Scalar s, Scalar t)
{
    int i;                        /* Misc index */
