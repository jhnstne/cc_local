...
\fpage{1}
\centerline{\bf THE KERNEL OF A FREEFORM SURFACE AND}
\vspace*{0.035truein}
\centerline{\bf ITS DUALITY WITH A CERTAIN CONVEX HULL}
\vspace*{0.37truein}
...
% which define the bitangent developables.
Computation of the convex hull of a freeform surface is discussed in \cite{3}.
% Once again, the computation of the bitangent developables of a surface
% can be reduced to the intersection of its tangential surfaces.
...
grants CCR-0203586 and CNS-0420614, in part by 
the Israel Science Foundation (grant No.~857/04), and in part by
