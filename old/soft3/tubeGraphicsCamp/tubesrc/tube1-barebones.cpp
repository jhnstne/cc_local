/*
  ...
  Purpose:	 Geometric modeling of a tube.
		 ...
		 Version to work on on Day 1.
		 This version includes nothing, leaving both input and
		 centering to the very sophisticated student.
  History:	 
*/
...
static GLboolean DRAWDATAPT=0;	// draw data points?
