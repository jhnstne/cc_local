/*
        ...
        Purpose: Given n points on the 3-sphere,
		 generate a rational Bezier curve interpolating these points.
	Reference: John K. Johnstone and James T. Williams (1996)
		   `Rational interpolating curves on the 3-sphere'
		   UAB Technical report, August 1996.
*/
...
{
	extern int INPUTDEMO, ALLFRAMES, DEBUG;
                   ...
                   const int   	      dirbez_num)
{
	...
	int i;
	extern int ALLFRAMES,DEBUG,presentm;
