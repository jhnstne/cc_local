/*
  File:          walkthrough.cpp (from 3d/surfbuild/src/surfinterpolate.cpp)
  Author:        J.K. Johnstone 
  Created:	 11 November 2004
  Last Modified: 11 November 2004
  Purpose:       First, read in a Unigrafix file of Soda Hall.  Then walkthrough it.
  Input:         Unigrafix file (see Seth Teller's documentation at his webpage under Data)
  History:
*/
