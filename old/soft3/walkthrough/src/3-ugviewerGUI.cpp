/*
  File:          ugviewerGUI.cpp (from ugviewer.cpp)
  Author:        J.K. Johnstone 
  Created:	 16 November 2004
  Last Modified: 16 November 2004
  Purpose:       Read and view a Unigrafix file, now with a more natural GUI.
                 Use arrows to control motion forward/backward/left/right and two other
		 keys for up/down.  This controls position alone.  
		 Mouse control of orientation is probably most natural.
